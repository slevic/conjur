  ...
  module AuthnK8s
    module K8sResolver
      ...
      class Deployment < Base
        def validate_pod
          replica_set_ref = pod_owner_refs && pod_owner_refs.find { |ref| ref.kind == "ReplicaSet" }
          ...
          deployment_ref = replica_set_owner_refs && replica_set_owner_refs.find { |ref| ref.kind == "Deployment" }
      ...
      class DeploymentConfig < Base
        def validate_pod
          replication_resource_ref = pod_owner_refs &&
          ...
          deployment_config_ref = replication_resource_owner_refs &&
            replication_resource_owner_refs.find { |ref| ref.kind == "DeploymentConfig" }
      ...
      class StatefulSet < Base
        def validate_pod
          stateful_set_ref = pod_owner_refs && pod_owner_refs.find { |ref| ref.kind == "StatefulSet" }
